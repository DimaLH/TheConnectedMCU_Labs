...
#define SERVO_30            (330)   //!< Definition of servo angle 
#define SERVO_60            (440)   //!< Definition of servo angle 
#define SERVO_90            (550)   //!< Definition of servo angle 
#define SERVO_120           (660)   //!< Definition of servo angle 
#define SERVO_150           (770)   //!< Definition of servo angle 
#define SERVO_180           (880)   //!< Definition of servo angle 
#define SERVO_X             (110)   //!< Definition of servo angle 
