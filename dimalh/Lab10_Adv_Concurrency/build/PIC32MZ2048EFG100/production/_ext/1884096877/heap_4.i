...
# 1 "<command-line>"
# 1 "../../../Source/portable/MemMang/heap_4.c"
# 37 "../../../Source/portable/MemMang/heap_4.c"
...
# 38 "../../../Source/portable/MemMang/heap_4.c" 2
...
# 45 "../../../Source/portable/MemMang/heap_4.c" 2
...
# 46 "../../../Source/portable/MemMang/heap_4.c" 2
# 65 "../../../Source/portable/MemMang/heap_4.c"
 static __uint8_t ucHeap[ ( ( size_t ) 60000 ) ];
...
# 84 "../../../Source/portable/MemMang/heap_4.c"
...
void *pvReturn = (0);
  ...
  if( ( xWantedSize & xBlockAllocatedBit ) == 0 )
  {
   ...
   if( xWantedSize > 0 )
   {
    ...
    if( ( xWantedSize & ( 0x0007 ) ) != 0x00 )
    {
     ...
     if( ( ( xWantedSize & ( 0x0007 ) ) == 0 ) == 0 ) vAssertCalled( "../../../Source/portable/MemMang/heap_4.c", 150 );
    }
    else
    {
     ;
   ...
   if( ( xWantedSize > 0 ) && ( xWantedSize <= xFreeBytesRemaining ) )
   {
    ...
    if( pxBlock != pxEnd )
    {
     ...
     pvReturn = ( void * ) ( ( ( __uint8_t * ) pxPreviousBlock->pxNextFreeBlock ) + xHeapStructSize );
     ...
     if( ( pxBlock->xBlockSize - xWantedSize ) > ( ( size_t ) ( xHeapStructSize << 1 ) ) )
     {
      ...
      pxNewBlockLink = ( void * ) ( ( ( __uint8_t * ) pxBlock ) + xWantedSize );
      if( ( ( ( ( size_t ) pxNewBlockLink ) & ( 0x0007 ) ) == 0 ) == 0 ) vAssertCalled( "../../../Source/portable/MemMang/heap_4.c", 195 );
 ...
 ( void ) xTaskResumeAll();
# 259 "../../../Source/portable/MemMang/heap_4.c"
 if( ( ( ( ( size_t ) pvReturn ) & ( size_t ) ( 0x0007 ) ) == 0 ) == 0 ) vAssertCalled( "../../../Source/portable/MemMang/heap_4.c", 259 );
 return pvReturn;
}
...
BlockLink_t *pxLink;
 ...
 if( pv != (0) )
 {
  ...
  if( ( ( pxLink->xBlockSize & xBlockAllocatedBit ) != 0 ) == 0 ) vAssertCalled( "../../../Source/portable/MemMang/heap_4.c", 279 );
  if( ( pxLink->pxNextFreeBlock == (0) ) == 0 ) vAssertCalled( "../../../Source/portable/MemMang/heap_4.c", 280 );
...
__uint8_t *pucAlignedHeap;
size_t uxAddress;
size_t xTotalHeapSize = ( ( size_t ) 60000 );
 ...
 pucAlignedHeap = ( __uint8_t * ) uxAddress;
...
__uint8_t *puc;
 ...
 puc = ( __uint8_t * ) pxIterator;
 if( ( puc + pxIterator->xBlockSize ) == ( __uint8_t * ) pxBlockToInsert )
 {
 ...
 puc = ( __uint8_t * ) pxBlockToInsert;
 if( ( puc + pxBlockToInsert->xBlockSize ) == ( __uint8_t * ) pxIterator->pxNextFreeBlock )
 {
