# 1 "../../../Source/portable/MPLAB/PIC32MZ/port.c"
# 1 "C:\\Users\\User\\Desktop\\Release\\Code\\FreeRTOS\\Lab10_Adv_Concurrency//"
# 1 "<command-line>"
# 1 "../../../Source/portable/MPLAB/PIC32MZ/port.c"
# 34 "../../../Source/portable/MPLAB/PIC32MZ/port.c"
...
# 35 "../../../Source/portable/MPLAB/PIC32MZ/port.c" 2
...
# 38 "../../../Source/portable/MPLAB/PIC32MZ/port.c" 2
...
# 41 "../../../Source/portable/MPLAB/PIC32MZ/port.c" 2
...
# 42 "../../../Source/portable/MPLAB/PIC32MZ/port.c" 2
# 125 "../../../Source/portable/MPLAB/PIC32MZ/port.c"
 static const __uint8_t ucExpectedStackBytes[] = {
         0xee, 0xee, 0xee, 0xee,
         0xee, 0xee, 0xee, 0xee,
         0xee, 0xee, 0xee, 0xee,
         0xee, 0xee, 0xee, 0xee,
         0xee, 0xee, 0xee, 0xee };
# 143 "../../../Source/portable/MPLAB/PIC32MZ/port.c"
...
__attribute__ ((aligned(8))) StackType_t xISRStack[ ( 400 ) ] = { 0 };





const StackType_t * const xISRStackTop = &( xISRStack[ ( ( 400 ) & ~( 0x0007 ) ) - 8 ] );




 __uint32_t ulTaskHasFPUContext = 0;
 ...
 *pxTopOfStack = (StackType_t) 0x12345678;
 pxTopOfStack--;

 *pxTopOfStack = (StackType_t) __builtin_mfc0(13,0);
 pxTopOfStack--;

 *pxTopOfStack = (StackType_t) ( ( 0x00000001 ) | ( 0x00000002 ) | ( 0x01000000 ) | ( 0x04000000 ) | ( 0x20000000 ) );
 pxTopOfStack--;
 ...
 *pxTopOfStack = (StackType_t) ( ( BaseType_t ) 0 );
...
static void prvTaskExitError( void )
{
 ...
 if( ( uxSavedTaskStackPointer == 0UL ) == 0 ) vAssertCalled( "../../../Source/portable/MPLAB/PIC32MZ/port.c", 218 );
...
# 233 "../../../Source/portable/MPLAB/PIC32MZ/port.c"
__attribute__(( weak )) void vApplicationSetupTickTimerInterrupt( void )
{
const __uint32_t ulCompareMatch = ( (( 40000000UL ) / 8) / ( ( TickType_t ) 1000 ) ) - 1UL;
...
void vPortEndScheduler(void)
{
 ...
 if( ( uxInterruptNesting == 1000UL ) == 0 ) vAssertCalled( "../../../Source/portable/MPLAB/PIC32MZ/port.c", 257 );
}
...
extern void *pxCurrentTCB;
...

 {
  ...
  memset( ( void * ) xISRStack, 0xee, sizeof( xISRStack ) );
 }
 ...
 IPC0CLR = 0x00001C00;
 IPC0SET = ( 0x01 << 0x0000000A );


 IEC0CLR = 0x00000002;
 IEC0SET = 1 << 0x00000001;
...
UBaseType_t uxSavedStatus;
 ...
 uxSavedStatus = uxPortSetInterruptMaskFromISR();
 {
  if( xTaskIncrementTick() != ( ( BaseType_t ) 0 ) )
  {
   ...
   __builtin_bsc0(13,0,( 0x00000100 ));
  }
 }
 vPortClearInterruptMaskFromISR( uxSavedStatus );


 if( ( ( memcmp( ( void * ) xISRStack, ( void * ) ucExpectedStackBytes, sizeof( ucExpectedStackBytes ) ) == 0 ) ) == 0 ) vAssertCalled( "../../../Source/portable/MPLAB/PIC32MZ/port.c", 318 );
...
UBaseType_t uxSavedStatusRegister;
 ...
 uxSavedStatusRegister = __builtin_mfc0(12,0) | 0x01;
 ...
 __builtin_mtc0(12,0,( ( uxSavedStatusRegister & ( ~( 0x7FUL << ( 10UL ) ) ) ) ) | ( 0x03 << ( 10UL ) ));
...
{
 __builtin_mtc0(12,0,uxSavedStatusRegister);
}
 ...
 {
 extern void vPortInitialiseFPSCR( __uint32_t uxFPSCRInit );

  vTaskEnterCritical();


  vPortInitialiseFPSCR((0x1000000));



  ulTaskHasFPUContext = ( ( BaseType_t ) 1 );
