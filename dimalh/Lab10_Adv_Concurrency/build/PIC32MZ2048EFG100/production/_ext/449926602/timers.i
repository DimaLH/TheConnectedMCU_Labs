...
# 257 "../../../Source/timers.c"
 ...
 if( ( xReturn ) == 0 ) vAssertCalled( "../../../Source/timers.c", 272 );
 return xReturn;
}
         ...
         Timer_t *pxNewTimer )
{
 ...
 if( ( ( xTimerPeriodInTicks > 0 ) ) == 0 ) vAssertCalled( "../../../Source/timers.c", 361 );
...
DaemonTaskMessage_t xMessage;
 ...
 if( ( xTimer ) == 0 ) vAssertCalled( "../../../Source/timers.c", 387 );
...
TaskHandle_t xTimerGetTimerDaemonTaskHandle( void )
{
 ...
 if( ( ( xTimerTaskHandle != (0) ) ) == 0 ) vAssertCalled( "../../../Source/timers.c", 429 );
...
Timer_t *pxTimer = ( Timer_t * ) xTimer;
 ...
 if( ( xTimer ) == 0 ) vAssertCalled( "../../../Source/timers.c", 438 );
...
TickType_t xReturn;
 ...
 if( ( xTimer ) == 0 ) vAssertCalled( "../../../Source/timers.c", 448 );
...
Timer_t *pxTimer = ( Timer_t * ) xTimer;
 ...
 if( ( xTimer ) == 0 ) vAssertCalled( "../../../Source/timers.c", 458 );
...
Timer_t * const pxTimer = ( Timer_t * ) ( (&( ( pxCurrentTimerList )->xListEnd ))->pxNext->pvOwner );
 ...
 if( pxTimer->uxAutoReload == ( UBaseType_t ) ( ( BaseType_t ) 1 ) )
 {
  ...
  if( prvInsertTimerInActiveList( pxTimer, ( xNextExpireTime + pxTimer->xTimerPeriodInTicks ), xTimeNow, xNextExpireTime ) != ( ( BaseType_t ) 0 ) )
  {
   ...
   if( ( xResult ) == 0 ) vAssertCalled( "../../../Source/timers.c", 485 );
   ( void ) xResult;
  }
  else
  {
 ...
 while( xQueueReceive( xTimerQueue, &xMessage, ( TickType_t ) 0U ) != ( ( ( BaseType_t ) 0 ) ) )
 {

  {
   ...
   if( xMessage.xMessageID < ( BaseType_t ) 0 )
   {
    ...
    if( ( pxCallback ) == 0 ) vAssertCalled( "../../../Source/timers.c", 708 );
  ...
  if( xMessage.xMessageID >= ( BaseType_t ) 0 )
  {
   ...
   switch( xMessage.xMessageID )
   {
    ...
    case ( ( BaseType_t ) 0 ) :
     ...
     if( prvInsertTimerInActiveList( pxTimer, xMessage.u.xTimerParameters.xMessageValue + pxTimer->xTimerPeriodInTicks, xTimeNow, xMessage.u.xTimerParameters.xMessageValue ) != ( ( BaseType_t ) 0 ) )
     {
      ...
      if( pxTimer->uxAutoReload == ( UBaseType_t ) ( ( BaseType_t ) 1 ) )
      {
       ...
       if( ( xResult ) == 0 ) vAssertCalled( "../../../Source/timers.c", 766 );
       ( void ) xResult;
      }
      else
      {
    ...
    case ( ( BaseType_t ) 9 ) :
     ...
     if( ( ( pxTimer->xTimerPeriodInTicks > 0 ) ) == 0 ) vAssertCalled( "../../../Source/timers.c", 789 );
...
BaseType_t xResult;
 ...
 while( ( ( BaseType_t ) ( ( pxCurrentTimerList )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
 {
  ...
  if( pxTimer->uxAutoReload == ( UBaseType_t ) ( ( BaseType_t ) 1 ) )
  {
   ...
   {
    xResult = xTimerGenericCommand( pxTimer, ( ( BaseType_t ) 0 ), xNextExpireTime, (0), ( TickType_t ) 0U );
    if( ( xResult ) == 0 ) vAssertCalled( "../../../Source/timers.c", 879 );
    ( void ) xResult;
   }
  }
  else
...
# 919 "../../../Source/timers.c"
   {
    xTimerQueue = xQueueGenericCreate( ( ( UBaseType_t ) 5 ), ( sizeof( DaemonTaskMessage_t ) ), ( ( ( __uint8_t ) 0U ) ) );
   }
# 936 "../../../Source/timers.c"
  }
  else
...
Timer_t *pxTimer = ( Timer_t * ) xTimer;
 ...
 if( ( xTimer ) == 0 ) vAssertCalled( "../../../Source/timers.c", 951 );
...
void *pvReturn;
 ...
 if( ( xTimer ) == 0 ) vAssertCalled( "../../../Source/timers.c", 972 );
...
Timer_t * const pxTimer = ( Timer_t * ) xTimer;
 ...
 if( ( xTimer ) == 0 ) vAssertCalled( "../../../Source/timers.c", 988 );
 ...
 BaseType_t xReturn;
  ...
  if( ( xTimerQueue ) == 0 ) vAssertCalled( "../../../Source/timers.c", 1032 );
