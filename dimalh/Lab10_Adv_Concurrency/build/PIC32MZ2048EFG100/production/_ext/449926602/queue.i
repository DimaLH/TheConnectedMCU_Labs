...
# 649 "../../../Source/include/queue.h"
BaseType_t xQueueGenericSend( QueueHandle_t xQueue, const void * const pvItemToQueue, TickType_t xTicksToWait, const BaseType_t xCopyPosition ) ;
# 743 "../../../Source/include/queue.h"
BaseType_t xQueuePeek( QueueHandle_t xQueue, void * const pvBuffer, TickType_t xTicksToWait ) ;
# 776 "../../../Source/include/queue.h"
BaseType_t xQueuePeekFromISR( QueueHandle_t xQueue, void * const pvBuffer ) ;
# 867 "../../../Source/include/queue.h"
BaseType_t xQueueReceive( QueueHandle_t xQueue, void * const pvBuffer, TickType_t xTicksToWait ) ;
# 882 "../../../Source/include/queue.h"
UBaseType_t uxQueueMessagesWaiting( const QueueHandle_t xQueue ) ;
# 899 "../../../Source/include/queue.h"
UBaseType_t uxQueueSpacesAvailable( const QueueHandle_t xQueue ) ;
# 913 "../../../Source/include/queue.h"
void vQueueDelete( QueueHandle_t xQueue ) ;
# 1294 "../../../Source/include/queue.h"
BaseType_t xQueueGenericSendFromISR( QueueHandle_t xQueue, const void * const pvItemToQueue, BaseType_t * const pxHigherPriorityTaskWoken, const BaseType_t xCopyPosition ) ;
BaseType_t xQueueGiveFromISR( QueueHandle_t xQueue, BaseType_t * const pxHigherPriorityTaskWoken ) ;
# 1384 "../../../Source/include/queue.h"
...
QueueHandle_t xQueueCreateMutex( const __uint8_t ucQueueType ) ;
QueueHandle_t xQueueCreateMutexStatic( const __uint8_t ucQueueType, StaticQueue_t *pxStaticQueue ) ;
...
# 1495 "../../../Source/include/queue.h"
 QueueHandle_t xQueueGenericCreate( const UBaseType_t uxQueueLength, const UBaseType_t uxItemSize, const __uint8_t ucQueueType ) ;
# 1555 "../../../Source/include/queue.h"
QueueSetHandle_t xQueueCreateSet( const UBaseType_t uxEventQueueLength ) ;
# 1579 "../../../Source/include/queue.h"
BaseType_t xQueueAddToSet( QueueSetMemberHandle_t xQueueOrSemaphore, QueueSetHandle_t xQueueSet ) ;
# 1598 "../../../Source/include/queue.h"
BaseType_t xQueueRemoveFromSet( QueueSetMemberHandle_t xQueueOrSemaphore, QueueSetHandle_t xQueueSet ) ;
# 1634 "../../../Source/include/queue.h"
...
__uint8_t ucQueueGetQueueType( QueueHandle_t xQueue ) ;
# 40 "../../../Source/queue.c" 2
# 89 "../../../Source/queue.c"
typedef struct QueueDefinition
{
 ...
 volatile __int8_t cRxLock;
 volatile __int8_t cTxLock;
...
static void prvInitialiseNewQueue( const UBaseType_t uxQueueLength, const UBaseType_t uxItemSize, __uint8_t *pucQueueStorage, const __uint8_t ucQueueType, Queue_t *pxNewQueue ) ;
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if( ( pxQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 252 );
 ...
 vTaskEnterCritical();
 {
  ...
  pxQueue->cRxLock = ( ( __int8_t ) -1 );
  pxQueue->cTxLock = ( ( __int8_t ) -1 );
...
# 359 "../../../Source/queue.c"
 ...
 __uint8_t *pucQueueStorage;

  if( ( uxQueueLength > ( UBaseType_t ) 0 ) == 0 ) vAssertCalled( "../../../Source/queue.c", 365 );
  ...
  if( pxNewQueue != (0) )
  {
   ...
   pucQueueStorage = ( ( __uint8_t * ) pxNewQueue ) + sizeof( Queue_t );
# 396 "../../../Source/queue.c"
...
static void prvInitialiseNewQueue( const UBaseType_t uxQueueLength, const UBaseType_t uxItemSize, __uint8_t *pucQueueStorage, const __uint8_t ucQueueType, Queue_t *pxNewQueue )
{
 ...
 if( uxItemSize == ( UBaseType_t ) 0 )
 {
  ...
  pxNewQueue->pcHead = ( __int8_t * ) pxNewQueue;
 }
 else
 {

  pxNewQueue->pcHead = ( __int8_t * ) pucQueueStorage;
 }
...
# 575 "../../../Source/queue.c"
 ...
 Queue_t * const pxMutex = ( Queue_t * ) xMutex;
  ...
  if( ( pxMutex ) == 0 ) vAssertCalled( "../../../Source/queue.c", 580 );
 ...
 Queue_t * const pxMutex = ( Queue_t * ) xMutex;
  ...
  if( ( pxMutex ) == 0 ) vAssertCalled( "../../../Source/queue.c", 635 );
...
# 700 "../../../Source/queue.c"
 ...
 QueueHandle_t xHandle;
  ...
  if( ( uxMaxCount != 0 ) == 0 ) vAssertCalled( "../../../Source/queue.c", 704 );
  if( ( uxInitialCount <= uxMaxCount ) == 0 ) vAssertCalled( "../../../Source/queue.c", 705 );

  xHandle = xQueueGenericCreate( uxMaxCount, ( ( UBaseType_t ) 0 ), ( ( __uint8_t ) 2U ) );
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if( ( pxQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 732 );
 if( ( !( ( pvItemToQueue == (0) ) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 733 );
 if( ( !( ( xCopyPosition == ( ( BaseType_t ) 2 ) ) && ( pxQueue->uxLength != 1 ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 734 );

 {
  if( ( !( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 737 );
 }
...
# 841 "../../../Source/queue.c"
  ...
  vTaskSuspendAll();
  vTaskEnterCritical(); { if( ( pxQueue )->cRxLock == ( ( __int8_t ) -1 ) ) { ( pxQueue )->cRxLock = ( ( __int8_t ) 0 ); } if( ( pxQueue )->cTxLock == ( ( __int8_t ) -1 ) ) { ( pxQueue )->cTxLock = ( ( __int8_t ) 0 ); } } vTaskExitCritical();
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if( ( pxQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 930 );
 if( ( !( ( pvItemToQueue == (0) ) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 931 );
 if( ( !( ( xCopyPosition == ( ( BaseType_t ) 2 ) ) && ( pxQueue->uxLength != 1 ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 932 );
# 948 "../../../Source/queue.c"
 ;
 ...
 uxSavedInterruptStatus = uxPortSetInterruptMaskFromISR();
 {
  if( ( pxQueue->uxMessagesWaiting < pxQueue->uxLength ) || ( xCopyPosition == ( ( BaseType_t ) 2 ) ) )
  {
   const __int8_t cTxLock = pxQueue->cTxLock;
...
# 1053 "../../../Source/queue.c"
   ...
   else
   {
    ...
    pxQueue->cTxLock = ( __int8_t ) ( cTxLock + 1 );
   }
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if( ( pxQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1087 );



 if( ( pxQueue->uxItemSize == 0 ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1091 );




 if( ( !( ( pxQueue->pcHead == (0) ) && ( pxQueue->pcTail != (0) ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1096 );
# 1112 "../../../Source/queue.c"
 ;
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if( ( ( pxQueue ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1247 );



 if( ( !( ( ( pvBuffer ) == (0) ) && ( ( pxQueue )->uxItemSize != ( UBaseType_t ) 0U ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1251 );



 {
  if( ( !( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1256 );
 }
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if( ( ( pxQueue ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1393 );



 if( ( pxQueue->uxItemSize == 0 ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1397 );



 {
  if( ( !( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1402 );
 }
  ...
  vTaskEnterCritical();
  {
   ...
   if( uxSemaphoreCount > ( UBaseType_t ) 0 )
   {
...

    {
     if( pxQueue->pcHead == (0) )
     {
      ...
      pxQueue->pcTail = ( __int8_t * ) pvTaskIncrementMutexHeldCount();
     }
     else
     {
      ;
   ...
   else
   {
    if( xTicksToWait == ( TickType_t ) 0 )
    {
     ...
     {
      if( ( xInheritanceOccurred == ( ( BaseType_t ) 0 ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1474 );
     }
...
BaseType_t xEntryTimeSet = ( ( BaseType_t ) 0 );
TimeOut_t xTimeOut;
__int8_t *pcOriginalReadPosition;
Queue_t * const pxQueue = ( Queue_t * ) xQueue;


 if( ( ( pxQueue ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1609 );



 if( ( !( ( ( pvBuffer ) == (0) ) && ( ( pxQueue )->uxItemSize != ( UBaseType_t ) 0U ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1613 );



 {
  if( ( !( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1618 );
 }
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if( ( pxQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1757 );
 if( ( !( ( pvBuffer == (0) ) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1758 );
# 1774 "../../../Source/queue.c"
 ;
 ...
 uxSavedInterruptStatus = uxPortSetInterruptMaskFromISR();
 {
  ...
  if( uxMessagesWaiting > ( UBaseType_t ) 0 )
  {
   const __int8_t cRxLock = pxQueue->cRxLock;
   ...
   else
   {
    ...
    pxQueue->cRxLock = ( __int8_t ) ( cRxLock + 1 );
   }
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if( ( pxQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1849 );
 if( ( !( ( pvBuffer == (0) ) && ( pxQueue->uxItemSize != ( UBaseType_t ) 0U ) ) ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1850 );
 if( ( pxQueue->uxItemSize != 0 ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1851 );
# 1867 "../../../Source/queue.c"
 ;
...
UBaseType_t uxReturn;
 ...
 if( ( xQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1900 );
...
Queue_t *pxQueue;
 ...
 if( ( pxQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1918 );
...
UBaseType_t uxReturn;
 ...
 if( ( xQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1934 );
...
Queue_t * const pxQueue = ( Queue_t * ) xQueue;
 ...
 if( ( pxQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 1946 );
 ;
# 1956 "../../../Source/queue.c"
 {
...
# 2016 "../../../Source/queue.c"
 ...
 UBaseType_t uxHighestPriorityOfWaitingTasks;
  ...
  {
   uxHighestPriorityOfWaitingTasks = ( 8UL ) - ( ( ( &( pxQueue->xTasksWaitingToReceive ) )->xListEnd ).pxNext->xItemValue );
  }
  else
  {
...
static void prvUnlockQueue( Queue_t * const pxQueue )
{
 ...
 vTaskEnterCritical();
 {
  __int8_t cTxLock = pxQueue->cTxLock;


  while( cTxLock > ( ( __int8_t ) 0 ) )
  {
...
# 2219 "../../../Source/queue.c"
 ...
 vTaskEnterCritical();
 {
  __int8_t cRxLock = pxQueue->cRxLock;

  while( cRxLock > ( ( __int8_t ) 0 ) )
  {
   if( ( ( BaseType_t ) ( ( &( pxQueue->xTasksWaitingToSend ) )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) == ( ( BaseType_t ) 0 ) )
   {
    if( xTaskRemoveFromEventList( &( pxQueue->xTasksWaitingToSend ) ) != ( ( BaseType_t ) 0 ) )
...
BaseType_t xReturn;
 ...
 if( ( xQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 2283 );
...
BaseType_t xReturn;
 ...
 if( ( xQueue ) == 0 ) vAssertCalled( "../../../Source/queue.c", 2322 );
...
# 2720 "../../../Source/queue.c"
 ...
 QueueSetHandle_t pxQueue;
  ...
  pxQueue = xQueueGenericCreate( uxEventQueueLength, ( UBaseType_t ) sizeof( Queue_t * ), ( ( __uint8_t ) 0U ) );
 ...
 BaseType_t xReturn = ( ( BaseType_t ) 0 );
  ...
  if( ( pxQueueSetContainer ) == 0 ) vAssertCalled( "../../../Source/queue.c", 2854 );
  if( ( pxQueueSetContainer->uxMessagesWaiting < pxQueueSetContainer->uxLength ) == 0 ) vAssertCalled( "../../../Source/queue.c", 2855 );

  if( pxQueueSetContainer->uxMessagesWaiting < pxQueueSetContainer->uxLength )
  {
   const __int8_t cTxLock = pxQueueSetContainer->cTxLock;
   ...
   {
    pxQueueSetContainer->cTxLock = ( __int8_t ) ( cTxLock + 1 );
   }
  }
  else
  {
