...
# 41 "../../../Source/event_groups.c" 2
# 1 "../../../Source/include/event_groups.h" 1
# 37 "../../../Source/include/event_groups.h"
# 1 "../../../Source/include/timers.h" 1
# 38 "../../../Source/include/event_groups.h" 2
# 82 "../../../Source/include/event_groups.h"
typedef void * EventGroupHandle_t;
# 92 "../../../Source/include/event_groups.h"
typedef TickType_t EventBits_t;
# 147 "../../../Source/include/event_groups.h"
 EventGroupHandle_t xEventGroupCreate( void ) ;
# 295 "../../../Source/include/event_groups.h"
EventBits_t xEventGroupWaitBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToWaitFor, const BaseType_t xClearOnExit, const BaseType_t xWaitForAllBits, TickType_t xTicksToWait ) ;
# 352 "../../../Source/include/event_groups.h"
EventBits_t xEventGroupClearBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToClear ) ;
# 485 "../../../Source/include/event_groups.h"
EventBits_t xEventGroupSetBits( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet ) ;
# 689 "../../../Source/include/event_groups.h"
EventBits_t xEventGroupSync( EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet, const EventBits_t uxBitsToWaitFor, TickType_t xTicksToWait ) ;
# 725 "../../../Source/include/event_groups.h"
EventBits_t xEventGroupGetBitsFromISR( EventGroupHandle_t xEventGroup ) ;
# 739 "../../../Source/include/event_groups.h"
void vEventGroupDelete( EventGroupHandle_t xEventGroup ) ;


void vEventGroupSetBitsCallback( void *pvEventGroup, const __uint32_t ulBitsToSet ) ;
void vEventGroupClearBitsCallback( void *pvEventGroup, const __uint32_t ulBitsToClear ) ;
# 42 "../../../Source/event_groups.c" 2
# 64 "../../../Source/event_groups.c"
typedef struct xEventGroupDefinition
{
 EventBits_t uxEventBits;
 List_t xTasksWaitingForBits;
# 76 "../../../Source/event_groups.c"
} EventGroup_t;
# 88 "../../../Source/event_groups.c"
static BaseType_t prvTestWaitCondition( const EventBits_t uxCurrentEventBits, const EventBits_t uxBitsToWaitFor, const BaseType_t xWaitForAllBits ) ;
# 143 "../../../Source/event_groups.c"
 EventGroupHandle_t xEventGroupCreate( void )
 {
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
 ...
 if( ( ( uxBitsToWaitFor & 0xff000000UL ) == 0 ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 184 );
 if( ( uxBitsToWaitFor != 0 ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 185 );

 {
  if( ( !( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ) ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 188 );
 }
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
 ...
 if( ( xEventGroup ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 306 );
 if( ( ( uxBitsToWaitFor & 0xff000000UL ) == 0 ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 307 );
 if( ( uxBitsToWaitFor != 0 ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 308 );

 {
  if( ( !( ( xTaskGetSchedulerState() == ( ( BaseType_t ) 0 ) ) && ( xTicksToWait != 0 ) ) ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 311 );
 }
...
EventBits_t uxReturn;
 ...
 if( ( xEventGroup ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 454 );
 if( ( ( uxBitsToClear & 0xff000000UL ) == 0 ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 455 );
...
BaseType_t xMatchFound = ( ( BaseType_t ) 0 );
 ...
 if( ( xEventGroup ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 516 );
 if( ( ( uxBitsToSet & 0xff000000UL ) == 0 ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 517 );
...
const List_t *pxTasksWaitingForBits = &( pxEventBits->xTasksWaitingForBits );
 ...
 vTaskSuspendAll();
 {
  ...
  while( ( ( pxTasksWaitingForBits )->uxNumberOfItems ) > ( UBaseType_t ) 0 )
  {
   ...
   if( ( pxTasksWaitingForBits->xListEnd.pxNext != ( const ListItem_t * ) &( pxTasksWaitingForBits->xListEnd ) ) == 0 ) vAssertCalled( "../../../Source/event_groups.c", 612 );
