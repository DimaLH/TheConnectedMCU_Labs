# 1 "../../../Source/tasks.c"
# 1 "C:\\Users\\User\\Desktop\\Release\\Code\\FreeRTOS\\Lab10_Adv_Concurrency//"
# 1 "<command-line>"
# 1 "../../../Source/tasks.c"
# 30 "../../../Source/tasks.c"
...
# 735 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\xc.h" 3
extern int __XC_UART;
# 749 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\xc.h" 3
typedef unsigned long _reg_t;
# 913 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\xc.h" 3
...
# 931 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\xc.h" 2 3
...
# 932 "c:\\program files (x86)\\microchip\\xc32\\v1.44\\pic32mx\\include\\xc.h" 2 3
# 74 "src/FreeRTOSConfig.h" 2
# 154 "src/FreeRTOSConfig.h"
 extern void vAssertCalled( const char * pcFile, unsigned long ulLine );
# 58 "../../../Source/include/FreeRTOS.h" 2


# 1 "../../../Source/include/projdefs.h" 1
# 36 "../../../Source/include/projdefs.h"
typedef void (*TaskFunction_t)( void * );
# 61 "../../../Source/include/FreeRTOS.h" 2
...
# 1 "../../../Source/portable/MPLAB/PIC32MZ/portmacro.h" 1
# 58 "../../../Source/portable/MPLAB/PIC32MZ/portmacro.h"
typedef __uint32_t StackType_t;
...
# 134 "../../../Source/portable/MPLAB/PIC32MZ/portmacro.h"
...
# 189 "../../../Source/portable/MPLAB/PIC32MZ/portmacro.h"
extern volatile UBaseType_t uxInterruptNesting;
# 54 "../../../Source/include/portable.h" 2
# 92 "../../../Source/include/portable.h"
# 1 "../../../Source/include/mpu_wrappers.h" 1
# 93 "../../../Source/include/portable.h" 2
...
{
 __uint8_t *pucStartAddress;
 size_t xSizeInBytes;
} HeapRegion_t;
# 124 "../../../Source/include/portable.h"
...
# 64 "../../../Source/include/FreeRTOS.h" 2
# 949 "../../../Source/include/FreeRTOS.h"
...
# 1020 "../../../Source/include/FreeRTOS.h"
  __uint32_t ulDummy18;
  __uint8_t ucDummy19;
...
# 1091 "../../../Source/include/FreeRTOS.h"
typedef struct xSTATIC_EVENT_GROUP
{
 TickType_t xDummy1;
 StaticList_t xDummy2;
# 1104 "../../../Source/include/FreeRTOS.h"
} StaticEventGroup_t;
# 1120 "../../../Source/include/FreeRTOS.h"
typedef struct xSTATIC_TIMER
{
 ...
 void *pvDummy5[ 2 ];
# 1135 "../../../Source/include/FreeRTOS.h"
} StaticTimer_t;
# 1151 "../../../Source/include/FreeRTOS.h"
...
# 345 "../../../Source/include/list.h"
void vListInitialise( List_t * const pxList ) ;
# 356 "../../../Source/include/list.h"
void vListInitialiseItem( ListItem_t * const pxItem ) ;
# 369 "../../../Source/include/list.h"
void vListInsert( List_t * const pxList, ListItem_t * const pxNewListItem ) ;
# 390 "../../../Source/include/list.h"
void vListInsertEnd( List_t * const pxList, ListItem_t * const pxNewListItem ) ;
# 405 "../../../Source/include/list.h"
UBaseType_t uxListRemove( ListItem_t * const pxItemToRemove ) ;
# 38 "../../../Source/include/task.h" 2
# 62 "../../../Source/include/task.h"
...
{
 void *pvBaseAddress;
 __uint32_t ulLengthInBytes;
 __uint32_t ulParameters;
} MemoryRegion_t;
...
typedef struct xTASK_STATUS
{
 ...
 __uint32_t ulRunTimeCounter;
 StackType_t *pxStackBase;
 __uint16_t usStackHighWaterMark;
} TaskStatus_t;
...
# 322 "../../../Source/include/task.h"
 BaseType_t xTaskCreate( TaskFunction_t pxTaskCode,
       const char * const pcName,
       const __uint16_t usStackDepth,
       void * const pvParameters,
       UBaseType_t uxPriority,
       TaskHandle_t * const pxCreatedTask ) ;
# 657 "../../../Source/include/task.h"
void vTaskAllocateMPURegions( TaskHandle_t xTask, const MemoryRegion_t * const pxRegions ) ;
# 698 "../../../Source/include/task.h"
void vTaskDelete( TaskHandle_t xTaskToDelete ) ;
# 750 "../../../Source/include/task.h"
void vTaskDelay( const TickType_t xTicksToDelay ) ;
# 809 "../../../Source/include/task.h"
void vTaskDelayUntil( TickType_t * const pxPreviousWakeTime, const TickType_t xTimeIncrement ) ;
# 834 "../../../Source/include/task.h"
BaseType_t xTaskAbortDelay( TaskHandle_t xTask ) ;
# 881 "../../../Source/include/task.h"
...
# 907 "../../../Source/include/task.h"
eTaskState eTaskGetState( TaskHandle_t xTask ) ;
# 963 "../../../Source/include/task.h"
void vTaskGetInfo( TaskHandle_t xTask, TaskStatus_t *pxTaskStatus, BaseType_t xGetFreeStackSpace, eTaskState eState ) ;
# 1005 "../../../Source/include/task.h"
void vTaskPrioritySet( TaskHandle_t xTask, UBaseType_t uxNewPriority ) ;
# 1056 "../../../Source/include/task.h"
void vTaskSuspend( TaskHandle_t xTaskToSuspend ) ;
# 1105 "../../../Source/include/task.h"
void vTaskResume( TaskHandle_t xTaskToResume ) ;
# 1134 "../../../Source/include/task.h"
BaseType_t xTaskResumeFromISR( TaskHandle_t xTaskToResume ) ;
# 1167 "../../../Source/include/task.h"
void vTaskStartScheduler( void ) ;
# 1223 "../../../Source/include/task.h"
void vTaskEndScheduler( void ) ;
# 1274 "../../../Source/include/task.h"
void vTaskSuspendAll( void ) ;
# 1328 "../../../Source/include/task.h"
BaseType_t xTaskResumeAll( void ) ;
# 1343 "../../../Source/include/task.h"
TickType_t xTaskGetTickCount( void ) ;
# 1359 "../../../Source/include/task.h"
TickType_t xTaskGetTickCountFromISR( void ) ;
# 1373 "../../../Source/include/task.h"
UBaseType_t uxTaskGetNumberOfTasks( void ) ;
# 1386 "../../../Source/include/task.h"
char *pcTaskGetName( TaskHandle_t xTaskToQuery ) ;
# 1402 "../../../Source/include/task.h"
TaskHandle_t xTaskGetHandle( const char *pcNameToQuery ) ;
# 1423 "../../../Source/include/task.h"
UBaseType_t uxTaskGetStackHighWaterMark( TaskHandle_t xTask ) ;
# 1476 "../../../Source/include/task.h"
BaseType_t xTaskCallApplicationTaskHook( TaskHandle_t xTask, void *pvParameter ) ;
# 1485 "../../../Source/include/task.h"
TaskHandle_t xTaskGetIdleTaskHandle( void ) ;
# 1584 "../../../Source/include/task.h"
UBaseType_t uxTaskGetSystemState( TaskStatus_t * const pxTaskStatusArray, const UBaseType_t uxArraySize, __uint32_t * const pulTotalRunTime ) ;
# 1631 "../../../Source/include/task.h"
void vTaskList( char * pcWriteBuffer ) ;
# 1685 "../../../Source/include/task.h"
void vTaskGetRunTimeStats( char *pcWriteBuffer ) ;
# 1766 "../../../Source/include/task.h"
BaseType_t xTaskGenericNotify( TaskHandle_t xTaskToNotify, __uint32_t ulValue, eNotifyAction eAction, __uint32_t *pulPreviousNotificationValue ) ;
# 1857 "../../../Source/include/task.h"
BaseType_t xTaskGenericNotifyFromISR( TaskHandle_t xTaskToNotify, __uint32_t ulValue, eNotifyAction eAction, __uint32_t *pulPreviousNotificationValue, BaseType_t *pxHigherPriorityTaskWoken ) ;
# 1934 "../../../Source/include/task.h"
BaseType_t xTaskNotifyWait( __uint32_t ulBitsToClearOnEntry, __uint32_t ulBitsToClearOnExit, __uint32_t *pulNotificationValue, TickType_t xTicksToWait ) ;
# 2035 "../../../Source/include/task.h"
void vTaskNotifyGiveFromISR( TaskHandle_t xTaskToNotify, BaseType_t *pxHigherPriorityTaskWoken ) ;
# 2104 "../../../Source/include/task.h"
__uint32_t ulTaskNotifyTake( BaseType_t xClearCountOnExit, TickType_t xTicksToWait ) ;
# 2120 "../../../Source/include/task.h"
BaseType_t xTaskNotifyStateClear( TaskHandle_t xTask );
# 2141 "../../../Source/include/task.h"
BaseType_t xTaskIncrementTick( void ) ;
# 2174 "../../../Source/include/task.h"
void vTaskPlaceOnEventList( List_t * const pxEventList, const TickType_t xTicksToWait ) ;
void vTaskPlaceOnUnorderedEventList( List_t * pxEventList, const TickType_t xItemValue, const TickType_t xTicksToWait ) ;
# 2188 "../../../Source/include/task.h"
void vTaskPlaceOnEventListRestricted( List_t * const pxEventList, TickType_t xTicksToWait, const BaseType_t xWaitIndefinitely ) ;
# 2214 "../../../Source/include/task.h"
BaseType_t xTaskRemoveFromEventList( const List_t * const pxEventList ) ;
void vTaskRemoveFromUnorderedEventList( ListItem_t * pxEventListItem, const TickType_t xItemValue ) ;
# 2225 "../../../Source/include/task.h"
...
# 2302 "../../../Source/include/task.h"
void vTaskStepTick( const TickType_t xTicksToJump ) ;
# 2318 "../../../Source/include/task.h"
...
typedef void (*PendedFunction_t)( void *, __uint32_t );
# 228 "../../../Source/include/timers.h"
 TimerHandle_t xTimerCreate( const char * const pcTimerName,
        const TickType_t xTimerPeriodInTicks,
        const UBaseType_t uxAutoReload,
        void * const pvTimerID,
        TimerCallbackFunction_t pxCallbackFunction ) ;
# 386 "../../../Source/include/timers.h"
void *pvTimerGetTimerID( const TimerHandle_t xTimer ) ;
# 407 "../../../Source/include/timers.h"
void vTimerSetTimerID( TimerHandle_t xTimer, void *pvNewID ) ;
# 444 "../../../Source/include/timers.h"
...
# 1187 "../../../Source/include/timers.h"
BaseType_t xTimerPendFunctionCallFromISR( PendedFunction_t xFunctionToPend, void *pvParameter1, __uint32_t ulParameter2, BaseType_t *pxHigherPriorityTaskWoken ) ;
# 1221 "../../../Source/include/timers.h"
BaseType_t xTimerPendFunctionCall( PendedFunction_t xFunctionToPend, void *pvParameter1, __uint32_t ulParameter2, TickType_t xTicksToWait ) ;
# 1232 "../../../Source/include/timers.h"
const char * pcTimerGetName( TimerHandle_t xTimer ) ;
# 1243 "../../../Source/include/timers.h"
TickType_t xTimerGetPeriod( TimerHandle_t xTimer ) ;
# 1258 "../../../Source/include/timers.h"
...
# 325 "../../../Source/tasks.c"
  volatile __uint32_t ulNotifiedValue;
  volatile __uint8_t ucNotifyState;
# 339 "../../../Source/tasks.c"
} tskTCB;
...
typedef tskTCB TCB_t;
 ...
 static List_t pxReadyTasksLists[ ( 8UL ) ];
...
# 453 "../../../Source/tasks.c"
static void prvIdleTask( void *pvParameters ) __attribute__((noreturn));
# 464 "../../../Source/tasks.c"
...
# 512 "../../../Source/tasks.c"
 static __uint16_t prvTaskCheckFreeStackSpace( const __uint8_t * pucStackByte ) ;
# 535 "../../../Source/tasks.c"
static void prvResetNextTaskUnblockTime( void );
# 551 "../../../Source/tasks.c"
static void prvInitialiseNewTask( TaskFunction_t pxTaskCode,
         const char * const pcName,
         const __uint32_t ulStackDepth,
         void * const pvParameters,
         UBaseType_t uxPriority,
         TaskHandle_t * const pxCreatedTask,
         TCB_t *pxNewTCB,
...
# 768 "../../../Source/tasks.c"
  ...
  {
# 808 "../../../Source/tasks.c"
   prvInitialiseNewTask( pxTaskCode, pcName, ( __uint32_t ) usStackDepth, pvParameters, uxPriority, pxCreatedTask, pxNewTCB, (0) );
...
# 851 "../../../Source/tasks.c"
 ...
 {
  pxTopOfStack = pxNewTCB->pxStack + ( ulStackDepth - ( __uint32_t ) 1 );
  pxTopOfStack = ( StackType_t * ) ( ( ( __uint32_t ) pxTopOfStack ) & ( ~( ( __uint32_t ) ( 0x0007 ) ) ) );


  if( ( ( ( ( __uint32_t ) pxTopOfStack & ( __uint32_t ) ( 0x0007 ) ) == 0UL ) ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 867 );
# 876 "../../../Source/tasks.c"
 }
# 891 "../../../Source/tasks.c"
 ...
 if( uxPriority >= ( UBaseType_t ) ( 8UL ) )
 {
  uxPriority = ( UBaseType_t ) ( 8UL ) - ( UBaseType_t ) 1U;
 }
 else
 {
  ;
 ...
 ( ( &( pxNewTCB->xEventListItem ) )->xItemValue = ( ( TickType_t ) ( 8UL ) - ( TickType_t ) uxPriority ) );
...
# 981 "../../../Source/tasks.c"
 {
  ...
  pxNewTCB->ucNotifyState = ( ( __uint8_t ) 0 );
 }
# 1009 "../../../Source/tasks.c"
 {
...
static void prvAddNewTaskToReadyList( TCB_t *pxNewTCB )
{
 ...
 if( xSchedulerRunning != ( ( BaseType_t ) 0 ) )
 {
  ...
  if( pxCurrentTCB->uxPriority < pxNewTCB->uxPriority )
  {
   { __uint32_t ulCause; ulCause = __builtin_mfc0(13,0); ulCause |= ( 0x01 << 8 ); __builtin_mtc0(13,0,ulCause); };
  }
  else
  {
   ;
 ...
 TCB_t *pxTCB;
  ...
  if( xSchedulerRunning != ( ( BaseType_t ) 0 ) )
  {
   if( pxTCB == pxCurrentTCB )
   {
    if( ( uxSchedulerSuspended == 0 ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 1189 );
    { __uint32_t ulCause; ulCause = __builtin_mfc0(13,0); ulCause |= ( 0x01 << 8 ); __builtin_mtc0(13,0,ulCause); };
   }
   else
   {
 ...
 BaseType_t xAlreadyYielded, xShouldDelay = ( ( BaseType_t ) 0 );
  ...
  if( ( pxPreviousWakeTime ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 1209 );
  if( ( ( xTimeIncrement > 0U ) ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 1210 );
  if( ( uxSchedulerSuspended == 0 ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 1211 );
 ...
 BaseType_t xAlreadyYielded = ( ( BaseType_t ) 0 );
  ...
  {
   if( ( uxSchedulerSuspended == 0 ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 1295 );
   vTaskSuspendAll();
   {
    ;
# 1307 "../../../Source/tasks.c"
 ...
 const TCB_t * const pxTCB = ( TCB_t * ) xTask;
  ...
  if( ( pxTCB ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 1339 );
...
# 1447 "../../../Source/tasks.c"
  ...
  vPortClearInterruptMaskFromISR( uxSavedInterruptState );
 ...
 BaseType_t xYieldRequired = ( ( BaseType_t ) 0 );
  ...
  if( ( ( uxNewPriority < ( 8UL ) ) ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 1472 );


  if( uxNewPriority >= ( UBaseType_t ) ( 8UL ) )
  {
   uxNewPriority = ( UBaseType_t ) ( 8UL ) - ( UBaseType_t ) 1U;
  }
  else
  {
   ;
...
# 1572 "../../../Source/tasks.c"
    ...
    {
     ( ( &( pxTCB->xEventListItem ) )->xItemValue = ( ( ( TickType_t ) ( 8UL ) - ( TickType_t ) uxNewPriority ) ) );
    }
    else
    {
     ;
 ...
 TCB_t *pxTCB;
  ...
  vTaskEnterCritical();
  {
   ...
   {
    if( pxTCB->ucNotifyState == ( ( __uint8_t ) 1 ) )
    {


     pxTCB->ucNotifyState = ( ( __uint8_t ) 0 );
    }
   }
  ...
  if( pxTCB == pxCurrentTCB )
  {
   if( xSchedulerRunning != ( ( BaseType_t ) 0 ) )
   {
    ...
    if( ( uxSchedulerSuspended == 0 ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 1698 );
    { __uint32_t ulCause; ulCause = __builtin_mfc0(13,0); ulCause |= ( 0x01 << 8 ); __builtin_mtc0(13,0,ulCause); };
   }
   else
   {
 ...
 const TCB_t * const pxTCB = ( TCB_t * ) xTask;
  ...
  if( ( xTask ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 1740 );
 ...
 TCB_t * const pxTCB = ( TCB_t * ) xTaskToResume;
  ...
  if( ( xTaskToResume ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 1782 );
 ...
 UBaseType_t uxSavedInterruptStatus;
  ...
  if( ( xTaskToResume ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 1837 );
# 1855 "../../../Source/tasks.c"
  ;
  ...
  vPortClearInterruptMaskFromISR( uxSavedInterruptStatus );
...
# 1933 "../../../Source/tasks.c"
 ...
 {
# 1973 "../../../Source/tasks.c"
  { __uint32_t ulStatus; ulStatus = __builtin_mfc0(12,0); if( ( ( ulStatus & ( 0x7FUL << ( 10UL ) ) ) >> ( 10UL ) ) < 0x03 ) { ulStatus &= ~( 0x7FUL << ( 10UL ) ); __builtin_mtc0(12,0,( ulStatus | ( 0x03 << ( 10UL ) ) )); } };
# 1983 "../../../Source/tasks.c"
 ...
 else
 {
  ...
  if( ( xReturn != ( -1 ) ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 2012 );
 }
...
BaseType_t xAlreadyYielded = ( ( BaseType_t ) 0 );
 ...
 if( ( uxSchedulerSuspended ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 2112 );
...
TCB_t *pxTCB;
 ...
 if( ( pxTCB ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 2276 );
...
BaseType_t xSwitchRequired = ( ( BaseType_t ) 0 );
 ...
 if( uxSchedulerSuspended == ( UBaseType_t ) ( ( BaseType_t ) 0 ) )
 {
  ...
  {
   { List_t *pxTemp; if( ( ( ( ( BaseType_t ) ( ( pxDelayedTaskList )->uxNumberOfItems == ( UBaseType_t ) 0 ) ) ) ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 2611 ); pxTemp = pxDelayedTaskList; pxDelayedTaskList = pxOverflowDelayedTaskList; pxOverflowDelayedTaskList = pxTemp; xNumOfOverflows++; prvResetNextTaskUnblockTime(); };
  }
  else
  {
   ;
...
void vTaskSwitchContext( void )
{
 ...
 else
 {
  ...
  ;
# 2892 "../../../Source/tasks.c"
  { const __uint32_t * const pulStack = ( __uint32_t * ) pxCurrentTCB->pxStack; const __uint32_t ulCheckValue = ( __uint32_t ) 0xa5a5a5a5; if( ( pulStack[ 0 ] != ulCheckValue ) || ( pulStack[ 1 ] != ulCheckValue ) || ( pulStack[ 2 ] != ulCheckValue ) || ( pulStack[ 3 ] != ulCheckValue ) ) { vApplicationStackOverflowHook( ( TaskHandle_t ) pxCurrentTCB, pxCurrentTCB->pcTaskName ); } };



  { UBaseType_t uxTopPriority; uxTopPriority = ( 31UL - __builtin_clz (( uxTopReadyPriority )) ); if( ( ( ( &( pxReadyTasksLists[ uxTopPriority ] ) )->uxNumberOfItems ) > 0 ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 2896 ); { List_t * const pxConstList = ( &( pxReadyTasksLists[ uxTopPriority ] ) ); ( pxConstList )->pxIndex = ( pxConstList )->pxIndex->pxNext; if( ( void * ) ( pxConstList )->pxIndex == ( void * ) &( ( pxConstList )->xListEnd ) ) { ( pxConstList )->pxIndex = ( pxConstList )->pxIndex->pxNext; } ( pxCurrentTCB ) = ( pxConstList )->pxIndex->pvOwner; }; };
  ;
# 2906 "../../../Source/tasks.c"
 }
}
...
void vTaskPlaceOnEventList( List_t * const pxEventList, const TickType_t xTicksToWait )
{
 if( ( pxEventList ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 2912 );
# 2921 "../../../Source/tasks.c"
...
void vTaskPlaceOnUnorderedEventList( List_t * pxEventList, const TickType_t xItemValue, const TickType_t xTicksToWait )
{
 if( ( pxEventList ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 2929 );



 if( ( uxSchedulerSuspended != 0 ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 2933 );
 ...
 void vTaskPlaceOnEventListRestricted( List_t * const pxEventList, TickType_t xTicksToWait, const BaseType_t xWaitIndefinitely )
 {
  if( ( pxEventList ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 2955 );
# 2967 "../../../Source/tasks.c"
  vListInsertEnd( pxEventList, &( pxCurrentTCB->xEventListItem ) );
...
# 3002 "../../../Source/tasks.c"
 ...
 if( ( pxUnblockedTCB ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 3003 );
...
TCB_t *pxUnblockedTCB;
 ...
 if( ( uxSchedulerSuspended != ( ( BaseType_t ) 0 ) ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 3058 );
 ...
 if( ( pxUnblockedTCB ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 3066 );
...
void vTaskSetTimeOutState( TimeOut_t * const pxTimeOut )
{
 if( ( pxTimeOut ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 3088 );
 vTaskEnterCritical();
 {
...
BaseType_t xReturn;
 ...
 if( ( pxTimeOut ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 3110 );
 if( ( pxTicksToWait ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 3111 );
...
UBaseType_t uxPriority;
 ...
 for( uxPriority = ( UBaseType_t ) 0U; uxPriority < ( UBaseType_t ) ( 8UL ); uxPriority++ )
 {
...
# 3628 "../../../Source/tasks.c"
 static __uint16_t prvTaskCheckFreeStackSpace( const __uint8_t * pucStackByte )
 {
 __uint32_t ulCount = 0U;

  while( *pucStackByte == ( __uint8_t ) ( 0xa5U ) )
  {
   pucStackByte -= -1;
   ulCount++;
  }

  ulCount /= ( __uint32_t ) sizeof( StackType_t );

  return ( __uint16_t ) ulCount;
 }
 ...
 UBaseType_t uxReturn;
  ...
  {
   pucEndOfStack = ( __uint8_t * ) pxTCB->pxStack;
  }
...
TCB_t *pxTCB;
 ...
 BaseType_t xReturn = ( ( BaseType_t ) 0 );
  ...
  if( pxMutexHolder != (0) )
  {
   ...
   if( pxMutexHolderTCB->uxPriority < pxCurrentTCB->uxPriority )
   {
    ...
    {
     ( ( &( pxMutexHolderTCB->xEventListItem ) )->xItemValue = ( ( TickType_t ) ( 8UL ) - ( TickType_t ) pxCurrentTCB->uxPriority ) );
    }
    else
    {
     ;
 ...
 BaseType_t xReturn = ( ( BaseType_t ) 0 );
  ...
  if( pxMutexHolder != (0) )
  {
   ...
   if( ( pxTCB == pxCurrentTCB ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 3899 );
   if( ( pxTCB->uxMutexesHeld ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 3900 );
   ( pxTCB->uxMutexesHeld )--;
   ...
   if( pxTCB->uxPriority != pxTCB->uxBasePriority )
   {
    ...
    if( pxTCB->uxMutexesHeld == ( UBaseType_t ) 0 )
    {
     ...
     ( ( &( pxTCB->xEventListItem ) )->xItemValue = ( ( TickType_t ) ( 8UL ) - ( TickType_t ) pxTCB->uxPriority ) );
     ; ( uxTopReadyPriority ) |= ( 1UL << ( ( pxTCB )->uxPriority ) ); vListInsertEnd( &( pxReadyTasksLists[ ( pxTCB )->uxPriority ] ), &( ( pxTCB )->xStateListItem ) ); ;
# 3943 "../../../Source/tasks.c"
     xReturn = ( ( BaseType_t ) 1 );
    }
 ...
 const UBaseType_t uxOnlyOneMutexHeld = ( UBaseType_t ) 1;
  ...
  if( pxMutexHolder != (0) )
  {
   ...
   if( ( pxTCB->uxMutexesHeld ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 3978 );
   ...
   if( pxTCB->uxPriority != uxPriorityToUse )
   {
    ...
    if( pxTCB->uxMutexesHeld == uxOnlyOneMutexHeld )
    {
     ...
     if( ( pxTCB != pxCurrentTCB ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 4005 );
     ...
     if( ( ( ( &( pxTCB->xEventListItem ) )->xItemValue ) & 0x80000000UL ) == 0UL )
     {
      ( ( &( pxTCB->xEventListItem ) )->xItemValue = ( ( TickType_t ) ( 8UL ) - ( TickType_t ) uxPriorityToUse ) );
     }
     else
     {
      ;
 ...
 void vTaskEnterCritical( void )
 {
  ...
  if( xSchedulerRunning != ( ( BaseType_t ) 0 ) )
  {
   ...
   {
    if( ( uxInterruptNesting == 0 ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 4086 );
   }
  }
  else
  {
 ...
 void vTaskExitCritical( void )
 {
  if( xSchedulerRunning != ( ( BaseType_t ) 0 ) )
  {
   if( pxCurrentTCB->uxCriticalNesting > 0U )
   {
    ...
    if( pxCurrentTCB->uxCriticalNesting == 0U )
    {
     { __uint32_t ulStatus; ulStatus = __builtin_mfc0(12,0); ulStatus &= ~( 0x7FUL << ( 10UL ) ); __builtin_mtc0(12,0,ulStatus); };
    }
    else
    {
     ;
...
TickType_t uxReturn;
 ...
 ( ( &( pxCurrentTCB->xEventListItem ) )->xItemValue = ( ( ( TickType_t ) ( 8UL ) - ( TickType_t ) pxCurrentTCB->uxPriority ) ) );
 ...
 __uint32_t ulReturn;
  ...
  vTaskEnterCritical();
  {
   ...
   if( pxCurrentTCB->ulNotifiedValue == 0UL )
   {
    ...
    pxCurrentTCB->ucNotifyState = ( ( __uint8_t ) 1 );
  ...
  vTaskEnterCritical();
  {
   ...
   if( ulReturn != 0UL )
   {
    ...
    {
     pxCurrentTCB->ulNotifiedValue = ulReturn - ( __uint32_t ) 1;
    }
   }
   else
   {
   ...
   pxCurrentTCB->ucNotifyState = ( ( __uint8_t ) 0 );
  }
  vTaskExitCritical();
 ...
 BaseType_t xReturn;
  ...
  vTaskEnterCritical();
  {
   ...
   if( pxCurrentTCB->ucNotifyState != ( ( __uint8_t ) 2 ) )
   {
 ...
 __uint8_t ucOriginalNotifyState;

  if( ( xTaskToNotify ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 4566 );
  ...
  vTaskEnterCritical();
  {
   ...
   pxTCB->ucNotifyState = ( ( __uint8_t ) 2 );
   ...
   switch( eAction )
   {
    ...
    case eSetValueWithoutOverwrite :
     if( ucOriginalNotifyState != ( ( __uint8_t ) 2 ) )
     {
      pxTCB->ulNotifiedValue = ulValue;
     }
     else
   ...
   if( ucOriginalNotifyState == ( ( __uint8_t ) 1 ) )
   {
    ( void ) uxListRemove( &( pxTCB->xStateListItem ) );
    ; ( uxTopReadyPriority ) |= ( 1UL << ( ( pxTCB )->uxPriority ) ); vListInsertEnd( &( pxReadyTasksLists[ ( pxTCB )->uxPriority ] ), &( ( pxTCB )->xStateListItem ) ); ;


    if( ( ( ( &( pxTCB->xEventListItem ) )->pvContainer ) == (0) ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 4622 );
# 4640 "../../../Source/tasks.c"
    if( pxTCB->uxPriority > pxCurrentTCB->uxPriority )
    {
 ...
 UBaseType_t uxSavedInterruptStatus;
  ...
  if( ( xTaskToNotify ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 4673 );
# 4691 "../../../Source/tasks.c"
  ;
  ...
  uxSavedInterruptStatus = uxPortSetInterruptMaskFromISR();
  {
   ...
   if( ucOriginalNotifyState == ( ( __uint8_t ) 1 ) )
   {
    ...
    if( ( ( ( &( pxTCB->xEventListItem ) )->pvContainer ) == (0) ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 4744 );
 ...
 UBaseType_t uxSavedInterruptStatus;
  ...
  if( ( xTaskToNotify ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 4796 );
# 4814 "../../../Source/tasks.c"
  ;
  ...
  uxSavedInterruptStatus = uxPortSetInterruptMaskFromISR();
  {
   ...
   if( ucOriginalNotifyState == ( ( __uint8_t ) 1 ) )
   {
    ...
    if( ( ( ( &( pxTCB->xEventListItem ) )->pvContainer ) == (0) ) == 0 ) vAssertCalled( "../../../Source/tasks.c", 4834 );
 ...
 BaseType_t xReturn;
  ...
  vTaskEnterCritical();
  {
   if( pxTCB->ucNotifyState == ( ( __uint8_t ) 2 ) )
   {
    pxTCB->ucNotifyState = ( ( __uint8_t ) 0 );
    xReturn = ( ( ( BaseType_t ) 1 ) );
   }
