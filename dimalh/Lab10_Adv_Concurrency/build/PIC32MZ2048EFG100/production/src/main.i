...
# 1 "src/ConfigPerformance.h" 1
# 77 "src/ConfigPerformance.h"
...
int main( void )
{
 ...
 prvSetupHardware();
    ...
    xTaskCreate(Task1, "Task 1", ( 190 ), (0), 2, (0) );
    xTaskCreate(Task2, "Task 2", ( 190 ), (0), 2, (0) );
...
void CreateTaskSyncStructures(void) {
    ...
    xMutexOLED = xQueueCreateMutex( ( ( __uint8_t ) 1U ) );
if( xMutexOLED == (0) )
{
while (1)
       ;
