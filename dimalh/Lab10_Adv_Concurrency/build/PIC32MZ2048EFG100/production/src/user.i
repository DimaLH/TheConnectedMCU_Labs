...
void Task1(void * pvParameters)
{
    char buff_1 [15] = "Mem - SW1 - SW4";
    while (1) {
        xQueueSemaphoreTake( ( xMutexOLED ), ( ( TickType_t ) 0xffffffffUL ) );
        if ((!PORTAbits.RA14) && (!PORTCbits.RC1) && (!PORTEbits.RE8))
        {
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( xMutexOLED ), (0), ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        vTaskDelay(1);
    }
...
void Task2(void * pvParameters) {
    ...
    char buff_3 [15] = "Heil, Gk";
    char buff_4 [15] = "I labVIEW";
    char buff_2 [15] = "I rodilsia";
